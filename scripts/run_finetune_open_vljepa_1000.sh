#!/usr/bin/env bash
# Fine-tune Open-VLJEPA on train_1000 filtered captions.
set -euo pipefail
...
LOG_FILE="${PROJECT_ROOT}/artifacts/logs/finetune-vljepa-train1000-$(date +%Y%m%d-%H%M%S).log"
echo "Open-VLJEPA FT train_1000. Log: ${LOG_FILE}"
